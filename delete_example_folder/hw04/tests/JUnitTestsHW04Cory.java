...
public class JUnitTestsHW04Cory
{
	@Rule
	...
	{
		assertEquals("321", RecursionExercises.displayBackwards(new int[]
		{ 1, 2, 3 }, 3));
		assertEquals("4-321", RecursionExercises.displayBackwards(new int[]
		{ 1, 2, -3, 4, 5 }, 4));
	...
	public void test19_RecursionExercisesGetSecondSmallest()
	{
		...
		{ 1, 2, 3 }, 3));
		assertEquals(new Integer(10), RecursionExercises.getSecondSmallest(new Integer[]
		{ 12, 10, 34, 16, 28, 92, -455 }, 7));
		assertEquals(new Integer(2), RecursionExercises.getSecondSmallest(new Integer[]
		{ 1, 2, 3, 4 }, 4));
		assertEquals(new Integer(10), RecursionExercises.getSecondSmallest(new Integer[]
		{ 12, 10, 34, 16, 28, 92, -455, 967437654 }, 8));
		assertEquals(new Integer(2), RecursionExercises.getSecondSmallest(new Integer[]
		{ 2, 2, 3 }, 3));
		assertEquals(new Integer(2), RecursionExercises.getSecondSmallest(new Integer[]
		{ 2, 2, 3, 4 }, 4));
